# pylint: disable=R0903,R0924,W0232
...
class ManaSymbolForm(forms.ModelForm):
    ...
    """
    class Meta:
        model = app.magic.models.ManaSymbol
...
class ManaCostForm(forms.ModelForm):
    ...
    """
    class Meta:
        model = app.magic.models.ManaCost
...
class SuperTypeForm(forms.ModelForm):
    ...
    """
    class Meta:
        model = app.magic.models.SuperType
...
class CardTypeForm(forms.ModelForm):
    ...
    """
    class Meta:
        model = app.magic.models.CardType
...
class SubTypeForm(forms.ModelForm):
    ...
    """
    class Meta:
        model = app.magic.models.SubType
...
class CardForm(forms.ModelForm):
    ...
    def clean(self):
        ...
        if kind == app.magic.models.Card.KIND_CHOICES[0][0]:
